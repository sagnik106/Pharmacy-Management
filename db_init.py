...
def initialize():
    ...
    cursor.execute('CREATE TABLE EMPLOYEE(F_NAME VARCHAR(10) NOT NULL, L_NAME VARCHAR(10), EMP_ID INT PRIMARY KEY, EMAIL VARCHAR(20), PHONE VARCHAR(10), DOB DATE)')
    cursor.execute('CREATE TABLE PRESCRIPTION(PRES_ID INT NOT NULL, QUANTITY INT, DOSE INT, D_NAME VARCHAR(10))')
    cursor.execute('CREATE TABLE INVOICE(C_NAME VARCHAR(30), PRES_ID INT NOT NULL, ENP_ID INT, IDATE DATE, PRICE FLOAT)')
